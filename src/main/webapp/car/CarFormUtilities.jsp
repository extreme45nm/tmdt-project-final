...
<body>
	...
	<c:choose>
		...
		<c:otherwise>
			<c:set var="action" value="add-utilities"></c:set>
		</c:otherwise>
	</c:choose>
	<!-- Control flow end -->
				...
				<div class="modal-body" align="center">
					<form:form method="POST" action="${action}" class="form-inline"
						...
						<div class="form-group">
							<label for="#airBag" class="pull-left">Airbag:</label><br>
							<form:input path="airBag" placeholder="Does it have air bags ?"
								class="form-control" id="airBag" size="62" />
						</div>
						<div class="form-group">
							<label for="#soundSystem" class="pull-left">HD Sound
								System:</label><br>
							<form:input path="soundSystem"
								placeholder="Does it have HD sound system?" class="form-control"
								id="soundSystem" size="62" />
						</div>
						<div class="form-group">
							<label for="#wheel" class="pull-left">Wheel support:</label><br>
							<form:input path="wheel"
								placeholder="Does it have Wheel support sytem?"
								class="form-control" id="wheel" size="62" />
						</div>
						<br>
						<div class="form-group">
							<input type="submit" value="Next (4/5)"
