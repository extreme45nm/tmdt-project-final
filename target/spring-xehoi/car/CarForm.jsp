		...
		<div class="container">
			...
			<div id="navBarLeftPart">
				<ul class="nav navbar-nav navbar-left">
					...
					<li class="active"><a href="form">Sell</a></li>
				...
				<div class="modal-body" style="padding: 40px 50px;">
					<form:form class="form-inline" method="POST" id="command"
						...
						<input type="submit" value="Submit"
							class="btn btn-success btn-block " id="submitButton">
					</form:form>
					<form enctype="multipart-file" method="post">
						<input type="file" name="file">
						<button value="Submit" type="submit"  ></button>
					</form>
				</div>
				<div class="modal-footer">
					<button id="submitButton" type="submit" class="btn btn-danger btn-default "
						data-dismiss="modal">
